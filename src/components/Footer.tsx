    ...
    <>
      <footer className="footer">
        <div className="footerInner">
          <div className="footerLogo">HONDA <span>KLATEN</span> — RIO</div>
          <p className="footerCopy">© {new Date().getFullYear()} Kredit Motor Honda Klaten. Harga dapat berubah sewaktu-waktu.</p>
